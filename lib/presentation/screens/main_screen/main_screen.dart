...
import 'package:checker/presentation/components/current_stage/current_stage.dart';
...
class _MainScreenState extends State<MainScreen> {
                  ...
                  return Column(
                    ...
                    children: [
                      Row(
                        children: [
                          Expanded(
                            child: CurrentStage(color: mobxMainScreenController.gameField.currentSide, winner:mobxMainScreenController.winner),
                          ),
                        ],
                      ),
                      SizedBox(
                                ...
                                children: [
                                  ...mobxMainScreenController.gameField.cells
                                    ...
                                    return Container(
                                      ...
                                      child: _LightMarker(
                                        cell: e,
                                        isLight: mobxMainScreenController
                                            .gameField
                                            .isLightedCell(e),
                                  ...
                                  ...mobxMainScreenController
                                      ...
                                      .map((i, e) {
                                    final coords =
                                        e.position.getPosition(cellWidth);
                                    return MapEntry(
                                        i,
                                        GestureDetector(
                                          onTap: () {
                      ...
                      Expanded(flex: 1,child: Column(children: [Row(
                        ...
                        CheckStack(
                            ...
                            count: mobxMainScreenController
  ...
  String currentTime(){
    final minutes = Duration(seconds: mobxMainScreenController.timeCounter).inMinutes;
    final seconds = Duration(seconds: mobxMainScreenController.timeCounter%60).inSeconds;
