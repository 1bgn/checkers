...
class Checker{
  ...
  Checker copy({GameCell? position,bool? isSelected}){
    return Checker(color: color, position: position??this.position,isSelected: isSelected??this.isSelected);
  }
  ...
  Checker({required this.color, required this.position,this.isSelected=false});
}